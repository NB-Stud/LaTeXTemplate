...
Durch Fortschritte in der Halbleiter- und Elektronikindustrie werden Steuerungsprobleme heute zunehmend mit diesen kompakten Mikrocontrollern gelöst, anstatt mit mechanischen oder elektrischen Schaltern.\cite{Arduino:2021b}
...
Das kompakte und zuverlässige BLE-Board basiert auf dem NINA-B306-Modul für Bluetooth Low Energy (BLE 5.0). Dieses Modul enthält den leistungsstarken Nordic nRF52480-Prozessor mit Cortex-M4F-CPU und ist vollständig kompatibel mit der Arduino IDE (online und offline). \cite{Arduino:2021}
...
\begin{table}
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Technische Spezifikation des Arduino Nano 33 BLE Sense \cite{Arduino:2021}}
\end{table}
