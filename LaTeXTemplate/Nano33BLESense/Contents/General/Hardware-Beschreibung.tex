...
\begin{itemize}
	...
	\end{itemize}
	\item Pinbelegung gemäß der Tabelle \ref{PinBelegungMOSFET}
	...
	\end{itemize}
\subsection{Einfacher Code}
Dies ist ein einfacher Code zur Ansteuerung eines MOSFETs.
...
\begin{code}[H]
	\caption{Einfacher Code zum Testen des MOS-FETs}
...
\begin{code}[H]
	\caption{Einfache Anwendung zum Verwenden des MOS-FETs}
	\label{code:AnwendungMOSFET}
	\ArduinoExternal{}{../../Code/Arduino/MOSFET/testMOSFET.ino}
\end{code}
%\subsection{Further Readings}
