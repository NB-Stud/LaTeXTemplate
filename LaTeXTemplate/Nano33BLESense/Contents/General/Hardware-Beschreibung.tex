...
\subsection{Einfache Anwendung}
Als Beispielhafte Anwendung für den HC-05 kann das Modul über einen Arduino und einem Relais mit einer Stehlampe verschaltet  werden. Wenn man das System dann mit einem Smartphone verbindet kann die Stehlampe über das System mit den HC-05 ein und ausgeschaltet werden. Das System kann folgenderweise verbunden werden: 
\begin{table}[h]
	\centering
...
\begin{code}[H]
	\caption{Code zur Überprüfung der Funktionalität}
	\label{code:Einfache_Anwendung}
	\ArduinoExternal{}{../../Code/Arduino/Bluetooth Modul/Einfache_Anwendung/Einfache_Anwendung.ino}
\end{code}
