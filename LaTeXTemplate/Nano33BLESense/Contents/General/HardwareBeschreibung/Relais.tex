...
\chapter{Relais 5V KY-019}\label{Relais}
\label{chap:relais}
...
Schlaak - Handbuch der Mess- und Automatisierungstechnik im Automobil, Seiten 279-296, Springer Verlag, 2006. \cite{Schlaak:2006}
\begin{itemize}
	\item Das Kapitel Elektromechanische Relais vermittelt alle nötigen Grundlagen und weiterführenden Informationen zum Thema Reilais.
\end{itemize}

Böhmer, Erwin - Elemente der angewandten Elektronik, Springer Verlag, 2018. \cite{Bohmer:2018}
\begin{itemize}
	\item Dieses Buch vermittelt einen spannenden Einstieg in die Welt der Elektronik. Es ist einfach zu verstehen und mit vielen Abbildungen versehen.
\end{itemize}