...
Das Projekt Magic Faucen Fountain beschäftigt sich mit der Umsetzung eines Brunnens, der die optische Täuschung eines schwebenden Wasserhahn erzeugt. Dabei scheint es, als würde Wasser kontinuierlich aus einem frei schwebenden Hahn fließen - ganz ohne sichtbare Verbindung zur Wasserquelle \ref{MagicFaucet}.
\begin{figure}[H]
	\centering
...
\begin{itemize}
	...
	\item 4-adriges Verbindungskabel (\(0{,}5\,\text{mm}^2\)) für:
	\begin{itemize}
...
Im Schaltplan \ref{5VSchaltplan} sind der Arduino Nano, das HC-05 Bluetooth-Modul und die Stromversorgung durch das Netzteil als Komponenten zu entnehmen. Es lassen sich folgende Schnittstellen aus der Schaltung herleiten:
	\begin{itemize}
	\item UART-Schnittstelle für die Bluetooth-Kommunikation (siehe TXD/RXD Verbindung zwischen Arduino und HC-05
	\item Digitale Ausgänge D2, D3, D4 zur Steuerung der Gate-Anschlüsse der MOS-FET-Schaltung für die Pumpe und LEDs
...
\begin{figure}[H]
	\centering
	\caption{Schaltplan: Arduino-basierte Steuerungseinheit mit Bluetooth-Kommunikation}
	\label{5VSchaltplan}
	\resizebox{1\textwidth}{!}{%
		\begin{circuitikz}
			\tikzstyle{every node}=[font=\Huge]
			\draw [ color={rgb,255:red,255; green,128; blue,0}, , line width=2pt](-5,16.5) to[short] (36.25,16.5);
			\draw [ line width=2pt](-5,-24.75) to[short] (32.5,-24.75);
			\draw [ line width=2pt , rounded corners = 12.0] (5,-13.5) rectangle (15,-18.5);
			\draw [ line width=2pt , rounded corners = 12.0] (5,6.5) rectangle (15,11.5);
			\draw [ line width=2pt , rounded corners = 12.0] (25,8) rectangle (32.5,-14.75);
			\draw [ line width=2pt](6.25,7.75) to[short, -o] (6.25,5.25) ;
			\draw [ line width=2pt](8.75,7.75) to[short, -o] (8.75,5.25) ;
			\draw [ line width=2pt](11.25,7.75) to[short, -o] (11.25,5.25) ;
			\draw [ line width=2pt](13.75,7.75) to[short, -o] (13.75,5.25) ;
			\node [font=\Huge] at (6.25,8.5) {\textbf{Vcc}};
			\node [font=\Huge] at (8.75,8.5) {\textbf{Trig}};
			\node [font=\Huge] at (11.25,8.5) {\textbf{Echo}};
			\node [font=\Huge] at (13.75,8.5) {\textbf{GND}};
			\node [font=\Huge, color={rgb,255:red,0; green,0; blue,255}] at (10,10.25) {\textbf{HC-SR04}};
			\node [font=\Huge, color={rgb,255:red,0; green,0; blue,255}] at (10,-17.5) {\textbf{HC-05}};
			\node [font=\Huge, color={rgb,255:red,0; green,0; blue,255}, rotate around={-90:(0,0)}] at (28.75,-3.75) {\textbf{Arduino Nano 33 BLE Sense (Lite)}};
			\draw [ line width=2pt](6.25,-14.75) to[short, -o] (6.25,-12.25) ;
			\draw [ line width=2pt](8.75,-14.75) to[short, -o] (8.75,-12.25) ;
			\draw [ line width=2pt](11.25,-14.75) to[short, -o] (11.25,-12.25) ;
			\draw [ line width=2pt](13.75,-14.75) to[short, -o] (13.75,-12.25) ;
			\node [font=\Huge] at (6.25,-15.25) {\textbf{Vcc}};
			\node [font=\Huge] at (8.75,-15.25) {\textbf{GND}};
			\node [font=\Huge] at (13.75,-15.25) {\textbf{RXD}};
			\node [font=\Huge] at (11.25,-15.25) {\textbf{TXD}};
			\draw [ line width=2pt](31.25,5.25) to[short, -o] (33.75,5.25) ;
			\draw [ line width=2pt](31.25,0.25) to[short, -o] (33.75,0.25) ;
			...
			\draw [ line width=2pt](26.25,-9.75) to[short, -o] (23.75,-9.75) ;
			\draw [ line width=2pt](26.25,-12.25) to[short, -o] (23.75,-12.25) ;
			\node [font=\Huge] at (31.25,6) {\textbf{VIN}};
			\node [font=\Huge] at (31.25,1) {\textbf{3V3}};
			\node [font=\Huge] at (26.25,6) {\textbf{GND}};
			\node [font=\Huge] at (26.25,3.5) {\textbf{TX}};
			\node [font=\Huge] at (26.25,1) {\textbf{RX}};
			\node [font=\Huge] at (26.25,-1.75) {\textbf{D2}};
			\node [font=\Huge] at (26.25,-4) {\textbf{D3}};
			\node [font=\Huge] at (26.25,-6.5) {\textbf{D4}};
			\node [font=\Huge] at (26.25,-9) {\textbf{D6}};
			\node [font=\Huge] at (26.25,-11.5) {\textbf{D9}};
			\draw [ color={rgb,255:red,255; green,128; blue,0}, , line width=2pt](36.25,16.5) to[short] (36.25,5.25);
			\draw [ color={rgb,255:red,255; green,128; blue,0}, , line width=2pt](36.25,5.25) to[short] (33.75,5.25);
			\draw [ line width=2pt](8.75,-12.25) to[short] (8.75,-9.75);
			\draw [ line width=2pt](8.75,-9.75) to[short] (2.5,-9.75);
			\draw [ line width=2pt](2.5,-9.75) to[short] (2.5,-24.75);
			\node at (2.5,-24.75) [circ] {};
			\node [font=\Huge] at (-7.5,-24.75) {\textbf{GND (5V)}};
			\draw [ line width=2pt](23.75,5.25) to[short] (21.25,5.25);
			\draw [ line width=2pt](36.25,-24.75) to[short] (32.5,-24.75);
			\draw [ color={rgb,255:red,255; green,128; blue,0}, , line width=2pt](6.25,-12.25) to[short] (6.25,-7.25);
			\draw [ color={rgb,255:red,255; green,128; blue,0}, , line width=2pt](6.25,-7.25) to[short] (-1.25,-7.25);
			\draw [ color={rgb,255:red,255; green,128; blue,0}, , line width=2pt](-1.25,-7.25) to[short] (-1.25,16.5);
			\node at (-1.25,16.5) [circ, color={rgb,255:red,255; green,128; blue,0}] {};
			\draw [ color={rgb,255:red,128; green,0; blue,255}, , line width=2pt](33.75,0.25) to[short] (35,0.25);
			\draw [ color={rgb,255:red,128; green,0; blue,255}, , line width=2pt](35,0.25) to[short] (35,14);
			\draw [ color={rgb,255:red,128; green,0; blue,255}, , line width=2pt](35,14) to[short] (3.75,14);
			\draw [ color={rgb,255:red,128; green,0; blue,255}, , line width=2pt](3.75,14) to[short] (3.75,4);
			\draw [ color={rgb,255:red,128; green,0; blue,255}, , line width=2pt](3.75,4) to[short] (6.25,4);
			\draw [ color={rgb,255:red,128; green,0; blue,255}, , line width=2pt](6.25,4) to[short] (6.25,5.25);
			\draw [ line width=2pt](21.25,5.25) to[short] (13.75,5.25);
			\draw [ color={rgb,255:red,0; green,255; blue,0}, , line width=2pt](23.5,-12.25) to[short] (17.5,-12.25);
			\draw [ color={rgb,255:red,0; green,255; blue,0}, , line width=2pt](17.5,-12.25) to[short] (17.5,-8.5);
			\draw [ color={rgb,255:red,0; green,255; blue,0}, , line width=2pt](17.5,-8.5) to[short] (8.75,-8.5);
			\draw [ color={rgb,255:red,0; green,255; blue,0}, , line width=2pt](8.75,-8.5) to[short] (8.75,5.25);
			\draw [ color={rgb,255:red,0; green,255; blue,0}, , line width=2pt](11.25,5.25) to[short] (11.25,-9.75);
			\draw [ color={rgb,255:red,0; green,255; blue,0}, , line width=2pt](11.25,-9.75) to[short] (23.75,-9.75);
			\draw [ color={rgb,255:red,255; green,0; blue,0}, , line width=2pt](23.75,2.75) to[short] (10,2.75);
			\draw [ color={rgb,255:red,255; green,0; blue,0}, , line width=2pt](10,2.75) to[short] (10,-11);
			\draw [ color={rgb,255:red,255; green,0; blue,0}, , line width=2pt](10,-11) to[short] (11.25,-11);
			\draw [ color={rgb,255:red,255; green,0; blue,0}, , line width=2pt](11.25,-11) to[short] (11.25,-12.25);
			\draw [ color={rgb,255:red,215; green,215; blue,0}, , line width=2pt](23.75,0.25) to[short] (13.75,0.25);
			\draw [ color={rgb,255:red,215; green,215; blue,0}, , line width=2pt](13.75,0.25) to[short] (13.75,-12);
			\draw [ line width=2pt](31.25,-12.25) to[short, -o] (33.75,-12.25) ;
			\draw [ line width=2pt](36.25,-24.75) to[short] (36.25,-12.25);
			\draw [ line width=2pt](36.25,-12.25) to[short] (33.75,-12.25);
			\node [font=\Huge] at (31.25,-11.5) {\textbf{GND}};
			\draw [ color={rgb,255:red,64; green,128; blue,128}, , line width=2pt](23.75,-7.25) to[short] (22.5,-7.25);
			\draw [ color={rgb,255:red,64; green,128; blue,128}, , line width=2pt](22.5,-7.25) to[short] (22.5,-17.25);
			\draw [ color={rgb,255:red,64; green,128; blue,128}, , line width=2pt](22.5,-17.25) to[short] (41.25,-17.25);
			\draw [ color={rgb,255:red,64; green,128; blue,128}, , line width=2pt](23.75,-4.75) to[short] (21.25,-4.75);
			\draw [ color={rgb,255:red,64; green,128; blue,128}, , line width=2pt](21.25,-4.75) to[short] (21.25,-18.5);
			\draw [ color={rgb,255:red,64; green,128; blue,128}, , line width=2pt](21.25,-18.5) to[short] (41.25,-18.5);
			\draw [ color={rgb,255:red,64; green,128; blue,128}, , line width=2pt](23.5,-2.25) to[short] (20,-2.25);
			\draw [ color={rgb,255:red,64; green,128; blue,128}, , line width=2pt](20,-2.25) to[short] (20,-19.75);
			\draw [ color={rgb,255:red,64; green,128; blue,128}, , line width=2pt](20,-19.75) to[short] (41.25,-19.75);
			\draw [ color={rgb,255:red,64; green,128; blue,128}, line width=2pt, ->, >=Stealth] (39.75,-17.25) -- (41.25,-17.25);
			\draw [ color={rgb,255:red,64; green,128; blue,128}, line width=2pt, ->, >=Stealth] (40,-18.5) -- (41.25,-18.5);
			\draw [ color={rgb,255:red,64; green,128; blue,128}, line width=2pt, ->, >=Stealth] (40,-19.75) -- (41.25,-19.75);
			\node [font=\Huge, color={rgb,255:red,64; green,128; blue,128}] at (46.5,-19.75) {\textbf{12V/MOSFET.1}};
			\node [font=\Huge, color={rgb,255:red,64; green,128; blue,128}] at (46.5,-18.5) {\textbf{12V/MOSFET.2}};
			\node [font=\Huge, color={rgb,255:red,64; green,128; blue,128}] at (46.5,-17.25) {\textbf{12V/MOSFET.3}};
			\draw (-5,16.5) to[short] (-6.5,16.5);
			\draw [ line width=2pt](-5,16.5) to[short] (-7.5,16.5);
			\draw [ line width=2pt](-11.25,16.5) to[short] (-8.75,19);
			\draw [ line width=2pt](-13.75,16.5) to[short] (-11.25,16.5);
			\draw [ line width=2pt](-10,17.75) to[short] (-10,20.25);
			\draw [ line width=2pt](-10,20.25) to[short] (-8.75,20.25);
			\draw [ line width=2pt](-10,20.25) to[short] (-11.25,20.25);
			\draw [ line width=2pt](-11.25,20.25) to[short] (-11.25,19.75);
			\draw [ line width=2pt](-8.75,20.25) to[short] (-8.75,19.75);
			\node [font=\Huge] at (-12,17.25) {3};
			\node [font=\Huge] at (-7,17.25) {4};
			\draw [ color={rgb,255:red,255; green,128; blue,0}, , line width=2pt](-13.75,16.5) to[short] (-17.5,16.5);
			\node [font=\Huge, color={rgb,255:red,255; green,128; blue,0}] at (-20,16.5) {+ 5 V};
			\draw [ line width=2pt , rounded corners = 12.0, dashed] (-13.75,21.5) rectangle  (-5,14);
			\node [font=\Huge, color={rgb,255:red,0; green,0; blue,255}] at (-9.25,22.25) {\textbf{Kippschalter}};
		\end{circuitikz}
	}%
\end{figure}

\subsubsection{5/12 V Netz mit Aktoren}
Komponenten dieser Schaltung sind: 3x N-Kanal-MOS-FETs, LED-Leuchten (grün und blau) und die Wasserpumpe. Dem Aufbau der Schaltung ist zu entnehmen, dass jeder MOS-FET als Schalter arbeitet, der über den Arduino gesteuert wird. Die genaue Ansteuerung der Komponenten durch den Arduino wird in Tabelle \ref{AnsteuerungArduino} dargestellt.
	\begin{center}
...
\end{center}
Die +Vin-Anschlüsse der Aktoren erhalten jeweils die notwendige Betriebsspannung direkt vom Netzteil, während die Schaltung über den MOS-FET den Stromfluss zum Masseanschluss (GND) kontrolliert. Eine detaillierte Darstellung der Schaltung ist in Abbildung \ref{12VSchaltplan} zu finden.
\begin{figure}[H]
	\centering
...
Die an der Bluetooth-Kommunikation beteiligten Komponenten sind der Arduino, HC-05 Bluetooth-Modul und das Smartphone mit der Bluetooth-App. 
Die serielle Kommunikation über UART (TX/RX) stellt die Hauptschnittstelle für die Steuerung dar. Eine Bluetooth-App sendet ASCII-Befehle oder einfache Steuersignale an den Arduino. Dieser wertet die empfangenen Daten aus und aktiviert über seine digitalen Pins die entsprechenden MOS-FET-Schaltungen.
\subsubsection{Arduino-Programmierschnittstelle}
Der Arduino Mikrokontroller wird mit einem Arduino Sketch (Arduino DIE) programmiert, der folgende Aufgaben übernimmt:
\begin{itemize}
...
\begin{figure}[H]
	...
	\resizebox{1\textwidth}{!}{%
		\begin{circuitikz}
			\tikzstyle{every node}=[font=\Huge]
			\draw [ line width=2pt , rounded corners = 12.0] (-51.25,175.25) rectangle  node {\Huge \textbf{Start RemoteXY}} (-43.75,172.5);
