...
Möchten Sie nun die Pumpe an- oder ausschalten, tippen Sie einfach bei \menu{19B10001} auf das $\uparrow$-Symbol. Sie gelangen ins \menu{Write Value}-Menü. Dort stellen Sie \menu{UTF-8} ein und können entweder \glqq An \grqq oder \glqq Aus \grqq schreiben. Die Pumpe wird dann jeweils an- oder ausgeschaltet werden.
