...
\begin{enumerate}
	...
	\item Klicke auf \glqq Installieren.
\end{enumerate}
...
Messung des Wasserstands im Reservoir verwendet, zu sehen in \ref{fig:schwimmer}. Dabei ersetzt der Sensor herkömmliche
...
\textbf{Aufbau des Schwimmerrohres}
\begin{figure}[!ht]
	\centering
	\resizebox{0.6\textwidth}{!}{%
		\begin{circuitikz}
			...
			\begin{scope}[rotate around={-87.5:(6.75,11.25)}]
				\draw[domain=6.75:12.25,samples=100, color={rgb,255:red,255; green,0; blue,0}, , line width=0.6pt] plot (\x,{1*sin(6.22*\x r -6.75 r ) +11.25});
			\end{scope}
			...
			\draw[domain=5.5:8.25,samples=100, color={rgb,255:red,0; green,128; blue,255}, , line width=0.6pt] plot (\x,{0.1*sin(10*\x r -0.5 r ) +4});
			\draw [line width=0.6pt, short] (5,3.25) -- (5.5,3.25);
			\draw [line width=0.6pt, short] (8.25,3.25) -- (8.75,3.25);
			\draw[domain=2.25:5,samples=100, color={rgb,255:red,0; green,128; blue,255}, , line width=0.6pt] plot (\x,{0.1*sin(10*\x r +2.75 r ) +4});
			\draw[domain=8.75:11.5,samples=100, color={rgb,255:red,0; green,128; blue,255}, , line width=0.6pt] plot (\x,{0.1*sin(10*\x r -3.75 r ) +4});
...
\begin{center}
	\begin{tabular}{p{8cm}|p{4cm}}
		...
		\hline
		Tränkler, H.-R.: \textit{Sensortechnik – Handbuch für Praxis und Wissenschaft}. 2. Aufl., Springer Vieweg, 2018 \cite{Traenkler:2018}
		& Very interesting because it provides a broad overview of sensor technologies with practical applications. \\
		\hline
		Hering, E.: \textit{Sensoren in Wissenschaft und Technik – Funktionsweise und Einsatzgebiete}. 3. Aufl., Springer Vieweg, 2023 \cite{Hering:2023}
		& Sehr interessant. \\
		\hline
