...
\label{grundlagen}
Um den Ultraschallsensor HC-SR04 gezielt und e`izient einsetzen zu können, ist ein
...
Laufzeitmessung und zur Berechnung der Distanz [ArduinoDoc24].
...
\begin{enumerate}
	\item Öffne die \textbf{Arduino IDE} (Version 1.8.x oder neuer empfohlen).
...
für Timingfehler und benötigt eine Kalibrierung der Umgebungsparameter, wie z. B. Temperatur
[Wil22].
Der Ablauf ist wie folgt:
\begin{enumerate}
	\item Trigger-Pin für 10 μs auf HIGH setzen (Anstoß des Schallimpulses).
	...
	Schallgeschwindigkeit von z. B. 343,2 m/s (bei 20 °C) [TM24].
\end{enumerate}
...
Wartungsfreiheit und Dichtigkeit entscheidend sind [HÜ23].
...
* zwischen Sensor und Wasseroberfläche und berechnet daraus den Wasserstand.
* 
* Die Berechnung erfolgt mit folgender Formel:
* \f[
* s = \text{Tankhöhe} - \text{gemessene Entfernung}
* \f]
* 
* Bei einem kritischen Wasserstand < 5 cm wird eine Warnung über die serielle
* Schnittstelle ausgegeben.
*/

#include <NewPing.h>

/// Pin für das Triggersignal des Ultraschallsensors
#define TRIGGER_PIN 9

/// Pin für das Echosignal des Ultraschallsensors
#define ECHO_PIN 6
...
/**
* @brief Hauptloop zur regelmäßigen Abstandsmessung und Wasserstandskontrolle.
*/
void loop() {
	delay(500);
	
	/// Gemessene Entfernung zur Wasseroberfläche in cm
...
/Code/Arduino/MagicFaucetFountain/WaterLevelSensor/
Sie bestehen aus:
\begin{itemize}
	\item dem Hauptsketch zur Wasserstandsmessung (z. B. WaterLevelSensor.ino)
...
Framework wie Blynk oder MQTT zur Fernüberwachung [HÜ23].
...
Schallgeschwindigkeit ausgeglichen werden. [HÜ23]
...
Entfernung über die serielle Schnittstelle ausgibt [Wil22].
...
systematisch verschiedene Einflüsse auf die Messgenauigkeit überprüft [HM21]:
\begin{itemize}
...
\begin{itemize}
	...
	[HÜ23].
	\item \textbf{Industrieautomation:} In Tanks und Silos, auch bei Staub oder Dampf [Wil22].
	\item \textbf{Fahrzeugtechnik:} Einparkhilfen und Abstandswarnsysteme [HM21].
...
Ultraschallsensoren gegenüber optischen Verfahren hervorgehoben [TM24

\section{Further Readings}
[HÜ23] Hüttinger, M.: Sensorik in der Praxis. Springer, 2023.\\
[TM24] Theodor, M.: Physikalische Grundlagen der Sensorik. Hanser, 2024.\\
[Wil22] Wilhelm, F.: Einführung in die Messtechnik. Vieweg+Teubner, 2022.\\
[HM21] Hesse, M.; Müller, T.: Akustik kompakt – Grundlagen, Anwendungen und Simulation.
Springer Vieweg, 2021.\\
[ArduinoDoc24] Arduino AG: NewPing – Library Documentation, Arduino.cc, abgerufen 2024.\\
