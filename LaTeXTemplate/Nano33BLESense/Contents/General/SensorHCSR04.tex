...
\chapter{Ultraschallsensor HC-SR04}\label{HCSR}
...
Der Ultraschallabstandssensor wird für die Verwendung bei der Temperatur von \parfillskip=0pt 20 °C ausgelegt. Die  berechnete Schallgeschwindigkeit $v_{Schall}=343,2\:\dfrac{\text{m}}{\text{s}}$ bei 20 °C wird für die Umrechnung der Schalldauer in die Distanz zur Reflexionsfläche verwendet.
%\Mynote{cite method}
