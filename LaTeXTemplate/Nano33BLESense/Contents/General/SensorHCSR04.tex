...
\begin{figure}[!ht]
	...
	\resizebox{1\textwidth}{!}{%
		\begin{circuitikz}
			...
			\draw [ fill={rgb,255:red,0; green,255; blue,0} , rounded corners = 1.2] (6.5,8) rectangle (6.75,7.25);
			\draw [ fill={rgb,255:red,0; green,0; blue,255} , rounded corners = 1.2] (7,8) rectangle (7.25,7.25);
			\draw [ fill={rgb,255:red,0; green,0; blue,0} , rounded corners = 1.2] (7.5,8) rectangle (7.75,7.25);
			\node [font=\LARGE] at (6.5,10) {HC-SR04};
			\node [font=\normalsize, color={rgb,255:red,0; green,255; blue,0}, rotate around={90:(0,0)}] at (6.5,8.5) {Trig};
			\node [font=\normalsize, color={rgb,255:red,0; green,0; blue,255}, rotate around={90:(0,0)}] at (7,8.5) {Echo};
...
Eine anschauliche Demonstration der Moeglichkeiten eines Ultraschallsensors stellt das Projekt Magic Faucet Fountain dar. Hierbei wird mit Hilfe des HC-SR04 ein Effekt erzeugt, bei dem ein scheinbar magisch schwebender Wasserstrahl bei Annaeherung der Hand unterbrochen oder aktiviert wird – ideal zur Beruehrungslosigkeit in Hygienebereichen oder als interaktives Kunstobjekt.
