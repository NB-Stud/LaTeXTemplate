...
in der Entfernungsmessung zu erwarten. (1) Umwelteinflüsse wie Feuchte, Staub und
...
sind CO2 und Dämpfe von Lösungsmitteln. (2)
...
empfangen wurde (4) Der Ultraschallsensor zur Abstandsmessung beruht auf ersterem
...
ausgesandten Ultraschallwellen handelt. (1)
Eine ganze Bandbreite an Objekten unabhängig von der Oberflächenbescha`enheit,
Farbe, Transparenz (2) und Form (1) kann durch den Ultraschall erfasst werden.
Der Ultraschall findet seine Anwendung in sehr vielen verschiedenen Bereichen (Kap.3),
...
Schüttgütern (1) oder der Detektion von Objekten und Grenzflächen dienen. Beispiel für
letztere Erwähnung ist die Rückfahrhilfe bei Fahrzeugen. Eine weitere sehr wichtige
