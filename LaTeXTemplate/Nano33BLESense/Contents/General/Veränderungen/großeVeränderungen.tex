...
\subsection{\menu{Nano33BLESense>Code}}
 ...
 \textbf{Änderungen im Hauptdokument \python{Nano33BLESence}}
     \begin{itemize}
 	\item \python{Kapitel 1: Einleitung} neu erstellt und geschrieben: \ref{chap:einleitungDoku}
 	\item \python{Kapitel 2: Arduino IDE 2.3.6} von Englisch auf Deutsch übersetzt, Bildschirmaufnahmen der Anwendung ersetzt durch neue Aufnahmen im hellen Bildschirmmodus : \ref{ArduinoIDE2}
 	\item \python{Kapitel 3: Einrichtung des Arduino Nano 33 BLE Sense} von Englisch auf Deutsch übersetzt, Bildschirmaufnahmen der Anwendung ersetzt durch neue Aufnahmen im hellen Bildschirmmodus : \ref{ArduinoNanoBLE} 
 	\item \python{Kapitel 4: Arduino Nano 33 BLE Sense} von Englisch auf Deutsch übersetzt: \ref{NanoBLESense}
