...
\part{Arduino Nano 33 BLE Sense - Interne Sensoren}
...
\part{Harwarebeschreibung: Magic Faucet Fountain}
	%%% Materialliste hier:
	\input{../../Contents/General/Materialliste Magic Faucet Fountain}
	%%%

  	%%% Hardware Beschreibung hier:
  	\input{../../Contents/General/SensorHCSR04}
...
\part{Applikation: Magic Faucet Fountain}
  ...
  \input{../../Contents/General/DokuProjektMagicFaucetFountain/BeschreibungSystem}
  %%%
