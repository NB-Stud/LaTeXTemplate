...
Der Magic Faucet Fountain erzeugt die Illusion, wie in \ref{fig:magicfaucet} zu sehen, in der ein Wasserhahn durch eine Wassersäule in der Luft gehalten wird. Der Wasserhahn schwebt auf dem Wasser mithilfe eines Acryl-Rohres und begießt die dekorativen Steine. Im Blumentopf befindet sich ein Wassertank, aus dem mithilfe einer Pumpe das Wasser gefördert wird. Der Wasserstand ist mit einer App auf dem Smartphone einsehbar. Zudem lässt sich die Pumpe ebenfalls durch die App ein- und ausschalten. Der Netzteilkasten ist zudem mit einem Hauptschalter (Kippschalter aus \ref{fig:ansichtApp}) ausgestattet, der das System ein- und ausschaltet. 
...
Laden Sie sich die nRF-Connect-App über den Google Playstore oder den Appstore auf Ihr Smartphone herunter. Schalten Sie die Bluetooth-Verbindung auf Ihrem Smartphone ein und suchen Sie nach in der Nähe befindlichen Geräten. Schalten Sie den Netzwerkkasten über den Kippschalter ein und überprüfen Sie, ob die grüne LED leuchtet. Ist dies der Fall warten Sie auf das Blinken der blauen LED. Sobald dies der Fall ist können Sie in der nRF-Connect-App die Verbindung mit dem Magic Faucet Fountain herstellen. Die Verbindung ist hergestellt, sobald die blaue LED konstant leuchtet. Nun können Sie Ihren Magic Faucet Fountain nutzen!
Die App verfügt über eine eine Füllstandsanzeige, zudem lässt sich die Pumpe über die App ansteuern.
