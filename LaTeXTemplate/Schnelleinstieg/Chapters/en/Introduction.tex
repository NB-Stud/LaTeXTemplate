...
The Magic Faucet Fountain is a device that creates the optical illusion of a floating water faucet. A transparent acrylic tube guides water from a pump inside the system upward to the faucet, where it exits and flows downward, visually concealing the tube (see Figure~\ref{fig:magicfauceteng}).  
An integrated ultrasonic sensor monitors the water level to prevent the pump from running dry. The measured values can be accessed in real time using the \textit{nRF Connect} app.
\begin{figure}[H]
	\centering
	...
	\caption{Schematic of the Magic Faucet Fountain}
	\label{fig:magicfauceteng}
\end{figure}
